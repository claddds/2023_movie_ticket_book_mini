...
public class Pay extends JDialog {
	...
	Sign_in sign_in;
	private Ticket_seat ticket_seat;
	JLabel remainingLabel_2,payLabel_2;
	...
	public void showticketPoint(int point) {
		payLabel_2.setText(String.valueOf(point)+"원");
		setVisible(true);
	}
